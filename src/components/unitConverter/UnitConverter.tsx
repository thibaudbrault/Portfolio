...
export const UnitConverter = () => {
  ...
  const features: string[] = useMemo(
    () => [
      ...
      "Utilisation de Changesets pour le versionning",
  ...
  const about: string[] = useMemo(
    () => [
      ...
      `Utilisation de Changesets comme outil de versionning afin de facilement changer le package de version et le publier`,
