...
export const ui = {
  fr: {
    ...
    'faqmaker.features[0]': `SaaS multi-tenant`,
    'faqmaker.features[1]': `Différents niveaux d'abonnements`,
    'faqmaker.features[2]': `Rôles et autorisations`,
    'faqmaker.features[3]': `Ajout / suppression d'utilisateurs`,
    'faqmaker.features[4]': `Questions / réponses`,
    'faqmaker.features[5]': `Ajout / suppression de tags`,
    'faqmaker.features[6]': `Réponses en Markdown`,
    ...
    'dashboard.features[0]': `CRUD complet et fonctionnel avec Supabase`,
    'dashboard.features[1]': `Chartes créées avec Tremor`,
    'dashboard.features[2]': `Liste des candidatures envoyées avec possibilité de modifier le statut`,
    'dashboard.features[3]': `Formulaire permettant d'ajouter de nouvelle candidatures`,
    'dashboard.about[0]': `Dashboard qui me permet de suivre mes candidatures et de conserver une trace.`,
  ...
  en: {
    ...
    'faqmaker.features[0]': `Multi-tenant SaaS`,
    'faqmaker.features[1]': `Different levels of subscriptions`,
    'faqmaker.features[2]': `Roles and permissions`,
    'faqmaker.features[3]': `Add / remove users`,
    'faqmaker.features[4]': `Questions / answers`,
    'faqmaker.features[5]': `Add / remove tags`,
    'faqmaker.features[6]': `Answers in Markdown`,
    ...
    'dashboard.features[0]': `Fully functional CRUD with Supabase`,
    'dashboard.features[1]': `Charts created with Tremor`,
    'dashboard.features[2]': `List of sent applications with the ability to modify the status`,
    'dashboard.features[3]': `Form to add new applications`,
    'dashboard.about[0]': `A dashboard that allows me to track my job applications and keep a record.`,
