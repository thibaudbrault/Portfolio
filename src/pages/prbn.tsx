    ...
    return (
        <Layout>
            <MainProject>
                ...
                <ProjectSubtitle>
                    Ecoutez toutes les musiques Pokémon avec ce lecteur de musique minimaliste{' '}
                ...
                <ProjectSection>
                    ...
                    <div>
                        ...
                        <p>
                            Plusiuers fonctions d'un lecteur de musique disponibles : lecture / pause, suivant / précédent, avancer / reculer de 10 secondes, musique au hasard et musique en boucle.
                            <br />
                            Affichage de la durée totale de la musique et de la progression de la musique avec un timer et une barre de progression.
                            <br />
                            Possibilité d'avancer ou de reculer dans la musique avec la barre de progression.
                        </p>
                    </div>
                    <div>
                        <span>
                    ...
                    <div>
                        ...
                        <p>
                            Animation de l'image du jeu qui tourne pour imiter un disque en marche.
                        </p>
                    </div>
                </ProjectSection>
                <ProjectSection>
                    ...
                    <div>
                        ...
                        <p>
                            La durée totale de la première musique affiche 0 lors du charegement du site.
                            <br />
                            Fonction loop qui ne joue pas automatiquement la musique lorsqu'elle arrive à la fin.
                        </p>
                    </div>
                    <div>
                        <span>
