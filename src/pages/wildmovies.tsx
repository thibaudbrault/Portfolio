			...
			<MainProject>
				...
				<ProjectSection>
					...
					<div>
						...
						<p>
							Possibilité d'effectuer des recherches par films, séries,
							personnalités ou les trois à la fois.
						</p>
					</div>
					<div>
						<span>
						...
						<p>
							Utilisation de plusieurs filtres cumulables pour les films et
							séries afin de pouvoir trouver précisement et rapidement
							l'information voulue.
							<br />
							Filtrer par : genre, plateforme de streaming, age, note, décennie
							(de 1900 à aujourd'hui) et durée.
							<br />
					...
					<div>
						...
						<p>
							...
							<br />
							Description détaillé des films et séries avec les genres, la
							durée, le synopsis, les acteurs, l'équipe technique, ...
							<br />
							Description détaillé des personnalités avec leur biographie, leur
							filmographie, ...
						</p>
					</div>
				</ProjectSection>
				<ProjectSection>
					...
					<div>
						...
						<p>
							Git workflow: utilisation de EsLint, Prettier et Husky afin
							d'avoir un code propre et sans erreur avant chaque commit.
							<br />
							Création de branches pour chaque features et création d'une
							branche "dev" qui a servi d'intermédiaire avant de merger sur la
							branche main afin d'avoir toujours une branche main fonctionnelle.
						</p>
					</div>
					<div>
						<span>
						...
						<p>Création d'un wireframe et d'une maquette Figma.</p>
					</div>
					<div>
						<span>
							<SiJirasoftware />
